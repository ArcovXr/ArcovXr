...
return (
    <div className="lg:flex w-full lg:w-15/16 lg:h-100 shadow-sm hover:shadow-lg transition-all shadow-gray-500 rounded-[35px] bg-gradient-to-b  justify-between  ">
        <div className="transition-all lg:w-2/5 lg:p-0 p-2  hover:cursor-pointer">
        <div className="bg-cover bg-center lg:rounded-none  rounded-4xl lg:rounded-l-[35px] h-full w-full"
            style={{ backgroundImage: `url(${image})` }}>
                <div className="transition-all lg:rounded-none  rounded-4xl bg-black opacity-50 hover:opacity-90 h-full w-full lg:rounded-l-4xl">
  ...
  <div>
    <div className="lg:text-2xl text-lg font-semibold text-white">
      {project}
    </div>
  ...
  <div className="flex w-full md:justify-end gap-5 md:gap-10 mt-10 items-center justify-center">
    <button 
      onClick={() => window.open(String(link), '_blank')} 
