...
import Logo_A3D from "./Icons/Logo_A3D";
import Logo_Angular from "./Icons/Logo_Angular";
import Logo_Astro from "./Icons/Logo_Astro";
import Logo_Blender from "./Icons/Logo_Blender";
import Logo_Css from "./Icons/Logo_Css";
import Logo_DVR from "./Icons/Logo_DVR";
import Logo_Figma from "./Icons/Logo_Figma";
import Logo_Html from "./Icons/Logo_Html";
import Logo_Java from "./Icons/Logo_Java";
import Logo_JS from "./Icons/Logo_JS";
import Logo_Maya from "./Icons/Logo_Maya";
import Logo_Py from "./Icons/Logo_Py";
import Logo_React from "./Icons/Logo_react";
import Logo_Tailwind from "./Icons/Logo_Tailwind";
import Logo_TS from "./Icons/Logo_TS";
import Logo_UE from "./Icons/Logo_UE";
import Logo_Unity from "./Icons/Logo_Unity";
import Tech_card from "./Techn_Card";
import Logo_SQL from "./Icons/Logo_MySql";
