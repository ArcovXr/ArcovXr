export default function VrBanner (){
    ...
    <>
          <div>
            <img src="https://i.pinimg.com/1200x/af/89/e4/af89e47ca19f630ca1af3a558a5573d7.jpg" className="w-full absolute top-0 left-0 h-full object-cover opacity-20 object-top"/>
